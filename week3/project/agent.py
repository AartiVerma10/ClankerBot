...
class Agent:
    ...
    def _run_loop(self) -> str:
        ...
        for _ in range(MAX_ITERATIONS):
            ...
            # FIXED: Do not exclude None values entirely to preserve 'content: null' fields for tool invocations
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            if user_input.startswith("/resume"):
                parts = user_input.split(maxsplit=1)  # FIXED: Handles spaces cleanly
                if len(parts) < 2:
